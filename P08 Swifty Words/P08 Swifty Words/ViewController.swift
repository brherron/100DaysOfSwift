...
//  P08 Swifty Words
//
//  Created by Beau Herron on 4/14/19.
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        NSLayoutConstraint.activate([
            ...
            cluesLabel.topAnchor.constraint(equalTo: scoreLabel.bottomAnchor, constant: 40),
            cluesLabel.leadingAnchor.constraint(equalTo: view.layoutMarginsGuide.leadingAnchor, constant: 100),
            cluesLabel.widthAnchor.constraint(equalTo: view.layoutMarginsGuide.widthAnchor, multiplier: 0.6, constant: -100),
            
            answersLabel.topAnchor.constraint(equalTo: scoreLabel.bottomAnchor, constant: 40),
            ...
            currentAnwser.widthAnchor.constraint(equalTo: view.layoutMarginsGuide.widthAnchor, multiplier: 0.5),
            currentAnwser.centerXAnchor.constraint(equalTo: view.layoutMarginsGuide.centerXAnchor),
        ...
        // Setup of buttons: creating buttons and adding them to buttonsView
        let width = 150
        let height = 80
